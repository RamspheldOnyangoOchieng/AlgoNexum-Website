        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="max-w-xl mb-12 md:mb-0">
            ...
            <p className="text-lg mb-8 leading-relaxed animate__animated animate__fadeIn animate__delay-1s">
              Crafting user-centered designs that elevate digital experiences, ensuring usability, accessibility, and aesthetic appeal.
            </p>
          ...
          <div className="relative max-w-lg">
            ...
            <img
              src="https://readdy.ai/api/search-image?query=UI%20UX%20design"
              alt="UI/UX Design"
